...
// Add VAPID key handler
const vapidPublicKey = 'BD6UDXVGMwXdXbxP6nA5YbfPdTlGa4Pu8Hb_LXAl9rvrzY_fROLf1qtcIZM7lAps7AA4iGDHoDyyZxPU1_y8QiQ';
...
const NotificationManager = {
  ...
  async sendEmailNotification(task) {
    ...
    try {
      await emailjs.send("service_i7nkph1", "template_nch18ji", {
        to_email: user,
...
// Replace the scheduleNotification function
function scheduleNotification(task) {
  ...
  if (notifyTime > now) {
    ...
    return NotificationManager.scheduleNotification(task, delay);
  }
  return false;
}
...
sendResetCode(email) {
  ...
  return emailjs.send("service_i7nkph1", "template_ubutexg", {
    to_email: email,
